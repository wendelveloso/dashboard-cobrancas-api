...
Este repositório deverá servir de base para ser realizado o fork para desenvolvimento da parte de **BACKEND** do desafio. O desafio deve ser feito utilizando express com o nodeJS  podendo ser feito os arquivos em `Javascript` ou `Typescript`, ficando a escolha da equipe.
...
E portanto o Pull Request de **FRONTEND** deverá ser criado a partir do fork de vocês do repositório base de FRONTEND desse desafio
...
- <b>Critérios de aceite</b>
  ...
  - O backend e banco de dados deverá ser hospedado na <b>heroku</b> OU deploys semelhantes ficando a escolha da equipe
